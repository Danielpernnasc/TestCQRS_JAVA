...
import com.Santander.CQRS.model.ReadModelCache;

import com.Santander.CQRS.repository.AccountRepository;
import com.Santander.CQRS.repository.TransactionRepository;
import com.Santander.CQRS.repository.UserRepository;
import com.Santander.CQRS.service.TransactionService;
import com.Santander.CQRS.model.Transaction;
import com.Santander.CQRS.model.TransactionType;
...
public class BankController {
        ...
        public ResponseEntity<?> summary(Authentication auth,
                ...
                Account acc = accounts.findByUser(user).orElseGet(() -> {
                        var a = new Account();
                        a.setUser(user);
                ...
                List<Map<String, String>> historico = txs.findByAccountOrderByTimestampDesc((Account) acc).stream()
                                .limit(limit)
                                .map(t -> Map.of(
